...
| 3 | `/implement-rules` — each rule on a rung that can fail | [board](https://remind-me-git-step-3-implement-rules-teamnate.vercel.app/spec/access) | [branch](https://github.com/nateshernandez/remind-me/tree/step-3-implement-rules) |
