...
// RULE-access-route-guard: the markdown table is the artifact a reviewer signs; this is plumbing.
const table = parseDecisionTable(readFileSync(join(import.meta.dirname, "RULE-access-route-guard.md"), "utf8"))
