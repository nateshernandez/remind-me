...
// RULE-access-callback-outcome: the markdown table is the artifact a reviewer signs; this is plumbing.
const table = parseDecisionTable(readFileSync(join(import.meta.dirname, "RULE-access-callback-outcome.md"), "utf8"))
