...
export const copy = defineCopy({
  ...
  "COPY-access-door-subtitle": "New here or not, it is the same address and the same code.",
  ...
  // Which of these shows is RULE-access-rejection-copy.
  "COPY-access-door-error-format": "That does not look like an email address.",
  "COPY-access-door-error-google": "Google could not be reached. You can still continue with a code.",
  "COPY-access-door-error-throttled": "Too many tries just now. Wait a moment and try again.",

  "COPY-access-door-blocked-title": "This address cannot be used to sign in",
  "COPY-access-door-blocked-body": "Nothing you typed is wrong. Email support@remind-me.app and a person will look at it.",
  "COPY-access-door-unavailable-title": "Sign-in is unavailable",
  "COPY-access-door-unavailable-body": "This is us, not you. Nothing you type will help right now — try again in a few minutes.",
  "COPY-access-door-signed-out-title": "You are signed out",
  "COPY-access-door-signed-out-body": "This browser no longer has access to your reminders.",
  "COPY-access-door-already-signed-in-title": "You are already signed in",
  "COPY-access-door-already-signed-in-body": "You signed in in another tab, so there is nothing to do here.",
  ...
  "COPY-access-code-wrong": "That code is not right. Check the email and try again.",
  "COPY-access-code-expired-title": "That code has expired",
  "COPY-access-code-expired-body": "Codes last ten minutes. Start again and we will send a fresh one.",
  ...
  "COPY-access-code-throttled-body": "Wait a moment before trying this code again.",
  ...
  "COPY-access-callback-declined-body": "Nothing happened. You can try Google again or use a code instead.",
  "COPY-access-callback-declined-action": "Back to sign in",
  "COPY-access-callback-failed-title": "Google could not sign you in",
  "COPY-access-callback-failed-body": "This address may already belong to an account that does not use Google. Signing in with a code will get you to it.",
  ...
  "COPY-access-callback-blocked-body": "Google signed you in, but this address is not one we can accept. Email support@remind-me.app and a person will look at it.",
  ...
  "COPY-access-app-session-ended-body": "You were signed out somewhere else. Sign in again to get back to your reminders.",
